This demo applications runs on a SPC56x Discovery board. The LED jumpers must be inserted and the serial connector
configured for RS232 mode.

The demo starts a thread showing flashing LEDs and another thread running
a command shell over LINFLEX0, you can use a terminal emulator in order to
